      ...
      <motion.div style={{ opacity, y: textY }} className="relative z-10 text-center max-w-6xl mx-auto px-6">
        ...
        <div className="overflow-hidden mb-4">
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} transition={{ duration: 1.2, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}>
            <h1 className="font-serif text-6xl md:text-8xl lg:text-[10rem] tracking-tight leading-[0.85] font-normal">
        ...
        <div className="overflow-hidden mb-8">
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} transition={{ duration: 1.2, delay: 0.6, ease: [0.22, 1, 0.36, 1] }}>
            <h1 className="font-serif text-6xl md:text-8xl lg:text-[10rem] tracking-tight leading-[0.85]">
...
function MarqueeDivider({ words, className = "" }: { words: string[]; className?: string }) {
  return (
    <div className={`py-6 border-y border-white/5 overflow-hidden ${className}`}>
      <Marquee>
        {words.map((w, i) => (
          <span key={i} className="mx-8 text-lg md:text-xl font-serif text-white/10 tracking-widest uppercase">
  ...
  return (
    <section className="relative py-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <RevealLine><h2 className="font-serif text-5xl md:text-7xl mb-4">Three Pillars</h2></RevealLine>
        <RevealLine delay={0.1}><h2 className="font-serif text-5xl md:text-7xl text-gold mb-20 italic">of Excellence</h2></RevealLine>
            ...
            <a href="#coaching" className="block w-full h-full relative overflow-hidden">
              ...
              <div className="absolute inset-0 p-8 flex items-center">
                <div>
                  ...
                  <h3 className="font-serif text-3xl md:text-4xl group-hover:text-gold transition-colors duration-500">Coaching</h3>
                </div>
          ...
          {stats.map((stat, i) => (
            <AnimatedSection key={stat.label} delay={i * 0.1}>
              <div className="text-center">
                <div className="font-serif text-5xl md:text-7xl text-gold mb-2">
      ...
      <div className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center py-32">
          <div>
            ...
            <RevealLine><h2 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[0.95]">With over</h2></RevealLine>
            <RevealLine delay={0.1}><h2 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[0.95] text-gold italic">15 years</h2></RevealLine>
            <RevealLine delay={0.2}><h2 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[0.95]">experience</h2></RevealLine>
          ...
          <div key={svc.num} className="w-screen h-screen flex-shrink-0 flex items-center bg-navy-dark">
            <div className="grid md:grid-cols-2 h-full w-full">
              <div className="flex flex-col justify-center px-8 md:px-20">
                ...
                <h4 className="font-serif text-4xl md:text-5xl leading-tight whitespace-pre-line mb-6">{svc.title}</h4>
            ...
            <div className="flex flex-wrap items-center gap-x-16 gap-y-6">
              {["Verco", "Lion Nathan", "Babcock & Brown", "Ageas"].map((c, i) => (
                <AnimatedSection key={c} delay={i * 0.1}>
                  <span className="text-white/20 hover:text-white/50 transition-colors text-xl font-serif tracking-wider distort-hover">{c}</span>
                </AnimatedSection>
              ))}
            </div>
          </div>
      ...
      <div className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-6">
            ...
            <RevealLine><h2 className="font-serif text-5xl md:text-7xl lg:text-8xl">Passionate About</h2></RevealLine>
            <RevealLine delay={0.15}><h2 className="font-serif text-5xl md:text-7xl lg:text-8xl text-gold italic">Brands for Asia</h2></RevealLine>
          </div>
        </div>
      </div>
              ...
              <AnimatedSection key={svc.num} delay={i * 0.1}>
                <Card3D className="border border-white/10 p-8 bg-white/[0.02] h-full group">
                  <div>
                    ...
                    <h4 className="font-serif text-2xl mt-4 mb-4 group-hover:text-gold transition-colors duration-500">{svc.title}</h4>
            ...
            <div className="relative border border-gold/20 overflow-hidden" style={{ boxShadow: "0 0 60px rgba(201,168,76,0.15), 0 0 120px rgba(201,168,76,0.05)" }}>
              <div className="grid md:grid-cols-5 min-h-[400px]">
                <div className="md:col-span-3 p-8 md:p-16 flex flex-col justify-center">
                  ...
                  <h3 className="font-serif text-4xl md:text-5xl mb-6"><GlitchText text="Uppercut Deluxe" /></h3>
    ...
    <motion.div style={{ opacity, scale }} className="absolute inset-0 flex items-center">
      <div className="grid md:grid-cols-2 h-full w-full">
        <div className="flex flex-col justify-center px-8 md:px-20">
          ...
          <h4 className="font-serif text-4xl md:text-5xl mb-6">{svc.title}</h4>
    ...
    <section id="coaching">
      <div className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-32">
          ...
          <RevealLine><h2 className="font-serif text-5xl md:text-7xl leading-[0.95]">Change subconscious</h2></RevealLine>
          <RevealLine delay={0.1}><h2 className="font-serif text-5xl md:text-7xl leading-[0.95] text-gold italic">beliefs that are</h2></RevealLine>
          <RevealLine delay={0.2}><h2 className="font-serif text-5xl md:text-7xl leading-[0.95]">self-limiting</h2></RevealLine>
                ...
                <Card3D className="border border-white/10 p-8 md:p-10 bg-white/[0.02] h-full">
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center"><span className="text-gold text-sm font-serif">{t.name[0]}</span></div>
  ...
  return (
    <section id="contact" className="relative py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <RevealLine><h2 className="font-serif text-6xl md:text-8xl lg:text-9xl">Let&apos;s Work</h2></RevealLine>
        <RevealLine delay={0.15}><h2 className="font-serif text-6xl md:text-8xl lg:text-9xl text-gold italic">Together</h2></RevealLine>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 items-start">
          <div>
            ...
            <p className="font-serif text-lg text-white/60">Sun Street</p>
